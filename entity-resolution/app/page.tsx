    ...
    <EntityResolutionProvider>
      <div className="flex flex-col h-full">
        <div className="container mx-auto p-4 flex-1 flex flex-col min-h-0">
          <h1 className="text-3xl font-bold mb-4 flex-shrink-0">Entity Resolution Review</h1>
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 flex-1 min-h-0">
            {/* Clusters Sidebar */}
            <div className="lg:col-span-1 flex flex-col min-h-0">
              <h2 className="text-xl font-semibold mb-3 flex-shrink-0">Clusters</h2>
            ...
            <div className="lg:col-span-3 flex flex-col min-h-0 gap-4">
              {/* Graph Visualization - Takes up 40% of available height */}
              <div className="bg-white rounded-lg border shadow-sm p-4 flex flex-col min-h-0" style={{ flex: '2 1 0%' }}>
                <h2 className="text-xl font-semibold mb-2 flex-shrink-0">Cluster Visualization</h2>
              ...
              {/* Connection Review Tools - Takes up 60% of available height */}
              <div className="bg-white rounded-lg border shadow-sm p-4 flex flex-col min-h-0" style={{ flex: '3 1 0%' }}>
                <div className="flex-1 min-h-0 overflow-hidden">
                  <Suspense fallback={<Skeleton className="h-full w-full" />}>
